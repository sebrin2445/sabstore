...
<h1 class="h2font">Update Contact</h1>


<form action="{{url('/update_contact_confirm',$contact->id)}}" method="POST" enctype="multipart/form-data">

@csrf
<div class="div_design">
<label for="">Name:</label>
<input type="text" class="inputcol" name="name" placeholder="write a name" required value="{{$contact->name}}">
</div>
<div class="div_design">
<label for="">Phone number:</label>
<input type="number" class="inputcol" name="phone" placeholder="type your number" required value="{{$contact->phone}}">
</div>
<div class="div_design">
<label for="">Email:</label>
<input type="text" class="inputcol" name="email" placeholder="write your email" required value="{{$contact->email}}">
</div>
<div class="div_design">
<label for="">Address:</label>
<input type="text" class="inputcol" name="address" placeholder="write your address" value="{{$contact->address}}">
</div>
...
<input type="submit"  value="Upadte Contact" class="btn btn-primary">
</div>
</form>
</div>
        <!-- main-panel ends -->
